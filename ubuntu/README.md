...
```
sudo apt-get install libssl-dev libusb-1.0-0-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libsdl1.2-dev libgtk-3-dev libudev-dev libsdl2-dev libgstreamer-plugins-bad1.0-dev protobuf-compiler protobuf-c-compiler libprotobuf-dev
```
